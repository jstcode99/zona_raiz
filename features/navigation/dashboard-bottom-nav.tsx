...
export function DashboardBottomNav({ items }: DashboardBottomNavProps) {
  ...
  return (
    <nav className={`fixed bottom-0 left-0 right-0 z-50 ${isMobile ? 'block': 'hidden'}`}>
      <div className="absolute inset-0 bg-white/85 backdrop-blur-xl border-t border-border" />
