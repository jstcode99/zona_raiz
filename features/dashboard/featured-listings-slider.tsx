...
export const FeaturedListingCard = ({ listing }: FeaturedListingCardProps) => {
  ...
  return (
    <Card className="overflow-hidden cursor-pointer pt-0 card-hover active:scale-[0.99] transition-all min-w-70 max-w-70">
      ...
      <div className="p-4">
        ...
        <h3 className="font-semibold text-foreground line-clamp-1 mt-1 capitalize">
          {property.title}
        </h3>
