...
export function LandingHero({ lang, cities = [] }: LandingHeroProps) {
  ...
  const onSubmit = (values: LandingSearchFormInput) => {
    ...
    if (values.min_bedrooms)
      formData.set("min_bedrooms", String(values.min_bedrooms));
    if (values.min_bathrooms)
      formData.set("min_bathrooms", String(values.min_bathrooms));
          ...
          <div className="w-full max-w-85 bg-white rounded-2xl shadow-2xl overflow-hidden shrink-0">
            ...
            >
              <div>
                ...
                <div
                  className={`flex items-center border rounded-xl px-3 h-11 gap-2 transition-colors focus-within:border-orange-400 ${errors.city ? "border-red-400" : "border-neutral-200"}`}
                >
              ...
              <div>
                ...
                <div
                  className={`flex items-center border rounded-xl px-3 h-11 gap-2 transition-colors focus-within:border-orange-400 ${errors.property_type ? "border-red-400" : "border-neutral-200"}`}
                >
              ...
              <div>
                ...
                <div
                  className={`flex items-center border rounded-xl px-3 h-11 gap-2 transition-colors focus-within:border-orange-400 ${errors.max_price ? "border-red-400" : "border-neutral-200"}`}
                >
