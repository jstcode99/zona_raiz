...
export const searchListingsAction = withServerAction(
  async (formData: FormData) => {
    ...
    if (validated.listing_type) params.set("listing_type", validated.listing_type);
    ...
    if (validated.neighborhood) params.set("neighborhood", validated.neighborhood);
    ...
    if (validated.min_bedrooms) params.set("min_bedrooms", String(validated.min_bedrooms));
    if (validated.min_bathrooms) params.set("min_bathrooms", String(validated.min_bathrooms));
