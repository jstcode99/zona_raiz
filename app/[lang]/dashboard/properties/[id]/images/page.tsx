...
export default async function page({ params }: props) {
  ...
  const { cookiesService, propertyService, propertyImageService } =
          ...
          <CardContent>
            <div className="w-full">
              <Suspense fallback={<Spinner />}>
                <PropertyImagesManager propertyId={id} fetch={fetchImages} />
              </Suspense>
            </div>
            <div className="mt-6 grid grid-cols-3 gap-4">
              ...
              <div className="border rounded-lg p-4 text-center">
                ...
                <p className="text-xs uppercase tracking-wider mt-1 opacity-70">
                  {t("components:property_images.formats_files")}
                </p>
              </div>
            </div>
          </CardContent>
