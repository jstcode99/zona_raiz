...
import { ListingSearchService, ListingSearchFilters } from "@/domain/services/listing-search.service"
...
async function getListings(filters: ListingSearchFiltersType): Promise<{ listings: ListingEntity[]; total: number }> {
  const { searchService } = await createListingModule()
  ...
  return searchService.searchWithCount(pickDefined(searchFilters))
}
